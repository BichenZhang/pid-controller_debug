...
#ref_dds_sel = 'Select reference DDS for this channel.'

pid_ignore = 'Ignore PID settings for this channel.'

rep_rate_mult = 'Multiple of the repetition rate used for gates.'
...
opt_sin = 'Turn on the DDS sinusoidal output.'

opt_dig = 'Turn on the DDS digital output.'
